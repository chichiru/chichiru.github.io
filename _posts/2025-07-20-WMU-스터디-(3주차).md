...
![fig5](/images/2025-07-20-WMU-스터디-(2주차)/fig5.png){: .w-75 .rounded-10}
_Fig.5. Forward sweep method_

#### Backward Sweep Method
n번 버스부터 1번 버스까지 측정한 전압과 전류, 그리고 임피던스를 이용하여 전압을 역순으로 계산

![fig6](/images/2025-07-20-WMU-스터디-(2주차)/fig6.png){: .w-75 .rounded-10}
...
![fig7](/images/2025-07-20-WMU-스터디-(2주차)/fig7.png){: .w-75 .rounded-10}
...
_Fig.10. Discrepancy index in Scenario 2 \\
